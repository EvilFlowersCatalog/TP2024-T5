/*! For license information please see 7631.e6bd2a10.js.LICENSE.txt */
"use strict";(self.webpackChunkglasskube_docs=self.webpackChunkglasskube_docs||[]).push([[7631],{77631:(t,e,r)=>{r.r(e),r.d(e,{CanaryTriggerSearchbar:()=>k});var n=r(44440),s=r(22697),a=r(34676);r(45793),r(6468);class i{constructor(t,e){this._handleKeyDown=t=>{(()=>"cmdk"===this._key?"k"===t.key&&(t.metaKey||t.ctrlKey):"slash"===this._key?"/"===t.key:void 0)()&&(t.preventDefault(),this.host.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0})))},(this.host=t).addController(this),this._key=e}hostConnected(){document.addEventListener("keydown",this._handleKeyDown)}hostDisconnected(){document.removeEventListener("keydown",this._handleKeyDown)}}var o=r(99408),c=r(14715),u=Object.defineProperty,d=Object.getOwnPropertyDescriptor,h=(t,e,r,n)=>{for(var s,a=n>1?void 0:n?d(e,r):e,i=t.length-1;i>=0;i--)(s=t[i])&&(a=(n?s(e,r,a):s(a))||a);return n&&a&&u(e,r,a),a};const l="canary-media-query";let b=class extends n.s{constructor(){super(...arguments),this.query="",this.matched=!1,this.handleChange=t=>{this.matched=t.matches}}connectedCallback(){if(super.connectedCallback(),!this.query)throw new Error(`'query' is required for '${l}'`);this.mediaQueryList=window.matchMedia(this.query),this.matched=this.mediaQueryList.matches,this.mediaQueryList.addEventListener("change",this.handleChange)}disconnectedCallback(){var t;super.disconnectedCallback(),null==(t=this.mediaQueryList)||t.removeEventListener("change",this.handleChange)}render(){return n.x`
...
.border{border-width:1px;};
    ...
    `],y([(0,a.n)({type:String})],k.prototype,"shortcut",2),k=y([(0,s.t)("canary-trigger-searchbar")],k)},45793:(t,e,r)=>{r.d(e,{s:()=>s});var n=r(50699);class s{constructor(t,e,r,n){if(this.subscribe=!1,this.provided=!1,this.value=void 0,this.t=(t,e)=>{this.unsubscribe&&(this.unsubscribe!==e&&(this.provided=!1,this.unsubscribe()),this.subscribe||this.unsubscribe()),this.value=t,this.host.requestUpdate(),this.provided&&!this.subscribe||(this.provided=!0,this.callback&&this.callback(t,e)),this.unsubscribe=e},this.host=t,void 0!==e.context){const t=e;this.context=t.context,this.callback=t.callback,this.subscribe=t.subscribe??!1}else this.context=e,this.callback=r,this.subscribe=n??!1;this.host.addController(this)}hostConnected(){this.dispatchRequest()}hostDisconnected(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=void 0)}dispatchRequest(){this.host.dispatchEvent(new n.s(this.context,this.t,this.subscribe))}}},50699:(t,e,r)=>{r.d(e,{s:()=>n});let n=class extends Event{constructor(t,e,r){super("context-request",{bubbles:!0,composed:!0}),this.context=t,this.callback=e,this.subscribe=r??!1}}},6468:(t,e,r)=>{r.d(e,{JF:()=>d,LL:()=>a,br:()=>s,iK:()=>c,pC:()=>i,qD:()=>o,vJ:()=>u});const n=t=>Symbol(t),s=n("theme"),a=n("operation"),i=n("mode"),o=n("query"),c=n("search"),u=n("ask"),d=n("tabs")},14715:(t,e,r)=>{r.d(e,{r:()=>s});var n=r(34676);function s(t){return(0,n.n)({...t,state:!0,attribute:!1})}}}]);