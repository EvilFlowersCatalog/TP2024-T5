/*! For license information please see 51.60f6e997.js.LICENSE.txt */
"use strict";(self.webpackChunkglasskube_docs=self.webpackChunkglasskube_docs||[]).push([[51],{51:(t,e,s)=>{s.r(e),s.d(e,{CanaryModal:()=>v,MODAL_CLOSE_EVENT:()=>$});var i=s(4440),o=s(2697),r=s(4676),n=s(1674),l=s(9408),a=Object.defineProperty,h=Object.getOwnPropertyDescriptor,c=(t,e,s,i)=>{for(var o,r=i>1?void 0:i?h(e,s):e,n=t.length-1;n>=0;n--)(o=t[n])&&(r=(i?o(e,s,r):o(r))||r);return i&&r&&a(e,s,r),r};let d=class extends i.s{constructor(){super(...arguments),this.ref=(0,n.e)()}render(){return i.x`
